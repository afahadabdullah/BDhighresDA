...
# task. A dependent CPU job pools the folds against the existing CPCv2 2023
# confirmation archive only after all six V7 tasks succeed.
...
echo "Submitting June 2023 V7 R81 pilot"
...
echo "  latest_latest meso: $V7_JUNE_MESO_CKPT"
echo "  latest_latest allocation: $V7_JUNE_ALLOC_CKPT"
...
echo "scores:  $V7_JUNE_ROOT/comparison/june2023_v7_r81_vs_cpcv2.md"
