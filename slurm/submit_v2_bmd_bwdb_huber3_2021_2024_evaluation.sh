...
# combined BMD+BWDB archive's single constrained holdout per season.
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
cd "$(cd -- "$SCRIPT_DIR/.." && pwd)"

export V2_CONFIRM_ROOT="${V2_BWDB_WINNER_ROOT:-data/processed/v2_bmd_bwdb_huber3_2021_2024}"
...
export V2_EVAL_COMPARISON_ROOT="${V2_EVAL_COMPARISON_ROOT:-$V2_BMD_ONLY_ROOT}"
